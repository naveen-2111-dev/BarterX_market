    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-900 to-gray-800 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        {nftData.listedNFTs.length > 0 && (
          <div>
            <div className="flex items-center mb-6">
              <ShoppingBag className="w-6 h-6 text-emerald-400 mr-2" />
...
function NFTCard({ nft, type, onClick }) {
  return (
    <div
      className="bg-gray-800 rounded-xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-1 cursor-pointer"
      onClick={onClick}
    >
      <div className="relative pb-[100%] bg-gray-700">
        {nft.image_url ? (
          ...
          <div className="absolute h-full w-full flex items-center justify-center bg-gray-700">
            <Gem className="w-12 h-12 text-gray-500" />
          </div>
        )}
      </div>
      <div className="p-4">
