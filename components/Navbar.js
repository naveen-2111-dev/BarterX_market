          ...
          <ul className="items-stretch hidden space-x-3 lg:flex ml-6">
            <li className="flex">
              <Link
                rel="noopener noreferrer"
                href="/"
                className="flex items-center px-4 -mb-1 border-b-2 border-transparent hover:border-emerald-400 hover:text-emerald-400 transition-colors duration-300"
              >
                products
              </Link>
            </li>
        ...
        <div className="flex items-center space-x-4">
          <div className="items-center flex-shrink-0 hidden lg:flex gap-4">
            ...
            <Link
              ...
              title="Profile"
            >
              <UserRoundIcon className="w-5 h-5 text-white hover:text-emerald-400" />
            </Link>
          </div>
